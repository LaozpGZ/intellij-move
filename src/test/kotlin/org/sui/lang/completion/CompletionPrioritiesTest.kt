...
module 0x1::Main {
    ...
    private fun checkCompletionsOrder(listStart: List<String>, @Language("Sui Move") code: String) {
    ...
    private fun checkFqCompletionsOrder(listStart: List<String>, @Language("Sui Move") code: String) {
        val variants = completionFixture.invokeCompletion(code)
        val lookupStrings =
