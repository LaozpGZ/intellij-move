...
val MOVE_KEYWORDS = tokenSetOf(
    ...
    MOVE, CONST_KW, NATIVE, FRIEND, ENTRY, INLINE, MACRO,
    ...
    FORALL, EXISTS, IN, WHERE, ENUM_KW, TYPE_KW, MATCH_KW
)
val CONTEXTUAL_KEYWORDS = tokenSetOf(MATCH_KW, MACRO, TYPE_KW)
